...
def generate_cave_map(
	...
	for generation in range(generations):
		...
		if generation < (generations - 2):
			...
			print("Turn any tile with more than 4 walls 1 away or less than 7 walls 2 away into a wall . . .")
			print_cave_to_terminal(new_map)
		
		elif generation == (generations - 2):
			print("\nGeneration: " + str(generation + 1))
			print("Turn any tile with more than 4 walls 1 away into a wall, otherwise turn it into a floor . . .")
			print_cave_to_terminal(new_map)
